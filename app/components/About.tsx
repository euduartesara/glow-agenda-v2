...
export default function About() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 bg-gradient-to-br from-fuchsia-600 via-pink-500 to-purple-600 text-white">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="group text-center">
            <div className="mx-auto w-20 h-20 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center shadow-lg">
              <svg
            ...
            <h3 className="mt-6 text-2xl font-semibold">Agendamento Fácil</h3>
            <p className="mt-3 text-white/80 max-w-xs mx-auto">
          ...
          <div className="group text-center">
            ...
            <h3 className="mt-6 text-2xl font-semibold">Profissionais Qualificados</h3>
            <p className="mt-3 text-white/80 max-w-xs mx-auto">
          ...
          <div className="group text-center">
            ...
            <h3 className="mt-6 text-2xl font-semibold">Pagamento Flexível</h3>
            <p className="mt-3 text-white/80 max-w-xs mx-auto">
